...
export default function CategoryBar({ activeCategory, setActiveCategory }: CategoryBarProps) {
  ...
  return (
    <aside className="bg-white w-full md:w-64 p-6  flex  md:justify-start  justify-center px-3  text-[11px]  md:text-md    text-gray-700  md:fixed md:h-screen font-bold shadow md:shadow-none">
