        ...
        <aside className="bg-white w-full md:w-64 p-6 text-gray-700 rounded-r-3xl md:fixed md:h-screen font-bold shadow md:shadow-none">
          <nav className="px-5 py-4">
            <div className="flex md:flex-col space-x-4 md:space-x-0 md:space-y-6 overflow-x-auto md:overflow-visible">
              <Link href="/tshirts" className="hover:text-black">NEW</Link>
              <Link href="/pants" className="hover:text-black">T-SHIRTS</Link>
              <Link href="/shoes" className="hover:text-black">HOODIES</Link>
              <Link href="/shorts" className="hover:text-black">SHORTS</Link>
              <Link href="/acessories" className="hover:text-black">ACCESSORIES</Link>
            </div>
          </nav>
        </aside>
